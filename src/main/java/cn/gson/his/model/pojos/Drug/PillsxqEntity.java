...
@Entity
@Table(name = "PILLSXQ", schema = "HIS", catalog = "")
public class PillsxqEntity {
    ...
    public boolean equals(Object o) {
        ...
        PillsxqEntity that = (PillsxqEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pillsxqId, productId, productName, productFl, sl, drugPrice, dw, yf, drugGe, drugSm, ph, bz, pillsId);
    }
}
